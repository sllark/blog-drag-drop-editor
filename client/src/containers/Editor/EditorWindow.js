...
// function getDragAfterElement(draggableElements, event) {
//
//     let y = event.clientY;
//     let x = event.clientX;
//     let offset, isInline = false;
//
//     // console.log(x, y);
//
//
...
//         const box = child.ref.current.getBoundingClientRect();
//
//         // console.log(box);
//
//         let dislpay = getComputedStyle(child.ref.current).display;
//
//         offset = -1;
//
//         //
...
//         //     //
//         //     // if (isInline){
//         //     //     console.log("closest.isInline",child,offset,closest.offset);
//         //     //
//         //     //
//         //     //     if (y >= box.y && y<= (box.y+box.height)){
//         //     //
...
//         //     //         isInline = false;
//         //     //
//         //     //         console.log("closest.isInline in box",child,offset,closest.offset);
//         //     //
//         //     //     }
//         //     //     else {
//         //     //         offset = closest.offset
...
//         //     //
//         //     //     // console.log(y, box);
//         //     //     // console.log("closest.not isInline",child,offset,closest.offset);
//         //     // }
//         //
//         //
//         // }
